  ...
  return (
    <div>
      <section className="w-full">
        <Head>
          <title>Dr. Quantum - Blog</title>
          <meta name="description" content="Drquantum.io - Your Generative AI second brain builder's blog" />
        </Head>
        ...
        <header className="bg-white text-zinc-900 py-4 border-b">
          <div className="container mx-auto px-4 md:px-6">
            <nav className="flex items-center justify-between">
              <Link href="/blog">
                <div className="text-2xl font-bold cursor-pointer">Dr. Quantum</div>
              </Link>
              <div className="space-x-4">
                <Link className="text-zinc-900 hover:text-zinc-700" href="/">Try Dr. Quantum</Link>
              </div>
            </nav>
          </div>
        </header>
